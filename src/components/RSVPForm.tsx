      ...
      <div className="bg-white rounded-3xl shadow-lg p-8 md:p-10">
        {submitSuccess ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            {/* Team */}
            <div>
              <label htmlFor="team" className="block text-sm font-medium text-text-primary mb-2">
                부서/팀
              </label>
              <input
                {...register('team')}
            ...
            <div>
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-text-primary">참석합니다</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    {...register('attend')}
                    ...
                    className="w-4 h-4 text-pink-500 focus:ring-pink-300"
                  />
                  <span className="text-text-primary">불참합니다</span>
                </label>
              </div>
              {errors.attend && (
                <p className="mt-1 text-sm text-red-500">{errors.attend.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                maxLength={300}
                className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-pink-300 focus:outline-none transition-colors resize-none"
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-pink-500 to-pink-400 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {isSubmitting ? (
                <>
